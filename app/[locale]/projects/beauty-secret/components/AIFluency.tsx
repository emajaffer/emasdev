...
const metrics: Metric[] = [
  { val: 445, descKey: 'aiCoAuthoredCommits' },
  { val: 95, suffix: '%', descKey: 'ofCommitsAiAssisted' },
  { val: 468, descKey: 'totalCommits' },
...
const typewriterLines: TypewriterLine[] = [
  { text: '# CLAUDE.md \u2014 590 lines of structured agent context', type: 'comment' },
  { text: '', type: 'blank' },
  { text: '## Purpose', type: 'keyword' },
  { text: '          # Business domain + 3 user roles', type: 'comment' },
  { text: '## Current Status', type: 'keyword' },
  { text: '    # 25+ implemented feature sections + roadmap', type: 'comment' },
  { text: '  ### Booking System', type: 'func' },
  { text: ' # Multi-service wizard, rewards, consultations', type: 'comment' },
  { text: '  ### Calendar', type: 'func' },
  { text: '       # Google Calendar-style, day/week/month views', type: 'comment' },
  { text: '  ### Payments', type: 'func' },
  { text: '      # Stripe Checkout, QR in-store, deposits, refunds', type: 'comment' },
  { text: '  ### Messaging', type: 'func' },
  { text: '     # Twilio SMS + SendGrid email (9 reminder types)', type: 'comment' },
  { text: '  ### Laser Forms', type: 'func' },
  { text: '   # Consent, treatment sheets, QR signing, PDF gen', type: 'comment' },
  { text: '  ### Inventory', type: 'func' },
  { text: '     # 448 products, 4 categories, restock tracking', type: 'comment' },
  { text: '  ### Loyalty', type: 'func' },
  { text: '       # 4-tier program, point ledger, 12-month expiry', type: 'comment' },
  { text: '  ### Campaigns', type: 'func' },
  { text: '     # Multi-channel SMS/email, audience filters', type: 'comment' },
  ...
  { text: '       # 38-table Convex schema + pricing convention', type: 'comment' },
  { text: '  ### Convex Modules', type: 'func' },
  { text: ' # 37-file module map + 21 helpers (module \u2192 purpose)', type: 'comment' },
  { text: '  ### Routing', type: 'func' },
  { text: '        # Full app/ directory tree + 51 routes', type: 'comment' },
  { text: '  ### Cron Jobs', type: 'func' },
  { text: '      # 14 scheduled jobs (campaigns, loyalty, payments)', type: 'comment' },
  { text: '  ### HTTP Webhooks', type: 'func' },
  { text: ' # 4 endpoints: Stripe, Twilio, SendGrid, Clerk', type: 'comment' },
  { text: '  ### Components', type: 'func' },
  { text: '     # 203 React components by domain + barrel imports', type: 'comment' },
  { text: '  ### Styling', type: 'func' },
  { text: '        # Brand colors, glass-morphism, gradients', type: 'comment' },
  { text: '  ### Testing', type: 'func' },
  { text: '        # Vitest + Playwright + SEO regression (600+)', type: 'comment' },
