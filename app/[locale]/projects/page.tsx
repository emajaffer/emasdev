...
export default async function ProjectsPage({
  ...
  const breadcrumbJsonLd = getBreadcrumbJsonLd([
    ...
    { name: t("title"), path: getRoutePath("projects", localeKey) },
  ]);

  const itemListJsonLd = getItemListJsonLd(t("title"), [
    {
      name: project.title,
      path: getRoutePath("beautySecret", localeKey),
      image:
        localeKey === "ro"
          ? "/screenshots/b-secret/landing-ro.png"
          : "/screenshots/b-secret/landing-page.png",
    },
  ]);
