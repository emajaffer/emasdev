...
export const metadata = {
  title: "Projects | EMA.dev — Ema Mocanu",
  description:
    "Portfolio projects by Ema Mocanu — full stack applications built with Next.js, React, TypeScript, and modern tooling.",
};
...
const projects = [
  {
    ...
    description:
      "A production-grade salon management platform with a 5-step booking wizard, Stripe payments, real-time Convex dashboards for 3 user roles, loyalty program, and bilingual support (EN/RO).",
      ...
      >
        ...
        <div className="mb-10 w-full rounded-3xl border border-white/30 bg-white/90 px-8 py-10 text-center shadow-2xl backdrop-blur-xl sm:px-12">
          ...
          <p className="mx-auto max-w-lg text-sm leading-relaxed text-text-muted sm:text-base">
            Full stack applications built from concept to production — each one
            a deep dive into real-world engineering.
          </p>
        </div>
