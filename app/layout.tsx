...
export const metadata: Metadata = {
  ...
  title: "EMA.dev | Software & Systems Engineer — Ema Mocanu",
  description:
    "Hi, I'm Ema — a software & systems engineer building with code, creativity, and AI. Explore my projects and the future I'm building, one idea at a time.",
  keywords: [
